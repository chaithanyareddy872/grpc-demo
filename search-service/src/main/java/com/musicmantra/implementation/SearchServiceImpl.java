...
public class SearchServiceImpl extends SearchServiceGrpc.SearchServiceImplBase {
    ...
    @Override
    public void searchByGenreInstrument(SearchServiceOuterClass.searchGenreInstrumentRequest request, StreamObserver<SearchServiceOuterClass.searchResponse> responseObserver) {
        Connection connection = getConnection();
        ...
        String query = "select sessionid,teacherid,sessionname,startdate,fees from sessions where instrumentid=? and genreid=? ";
    ...
    @Override
    public void searchByFees(SearchServiceOuterClass.serachFeeRequest request, StreamObserver<SearchServiceOuterClass.searchResponse> responseObserver) {
        Connection connection = getConnection();

        SearchServiceOuterClass.searchResponse.Builder respone = SearchServiceOuterClass.searchResponse.newBuilder();

        int fees = request.getFees();
        String query = "select sessionid,teacherid,sessionname,startdate,fees from sessions where fees=?";
    ...
    @Override
    public void searchByCity(SearchServiceOuterClass.searchCityRequest request, StreamObserver<SearchServiceOuterClass.searchResponse> responseObserver) {
        Connection connection = getConnection();
        ...
        String query = "select sessionid,teacherid,sessionname,startdate,fees from sessions where teacherid in\n" +
                "(select teacherid from teachers where userid in\n" +
                " (select userid from users where usertype='teacher' and userid in \n" +
                "(select userid from address where city=?)))";
        ...
        try {
            ...
            statement.setString(1, request.getCity());
